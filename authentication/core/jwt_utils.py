...
class TokenManager:
    """Enhanced JWT token manger with Redis caching"""
    @staticmethod
    ...
    def generate_tokens(user):
        """Generate secue access and refresh tokens with enhanced claims and security"""
        try:
    ...
    def refresh_tokens(refresh_token):
        ...
        try:
            ...
            try:
                ...
                logger.warning(f"Token refresh attempted for a non-existent user Id: {user_id}")

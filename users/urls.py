...
urlpatterns = [
    ...
    path("vendor/update-product/<slug:slug>/", VendorViewSet.as_view({"put": "update_product", "patch": "update_product"})),
    path("vendor/delete-product/<slug:slug>/", VendorViewSet.as_view({"delete": "delete_product"})),
    ...
    path("admin/vendors/<uuid:pk>/approve/", BusinessAdminViewSet.as_view({"post": "approve_vendor"})),
    path("admin/users/<uuid:pk>/suspend/", BusinessAdminViewSet.as_view({"post": "suspend_user"})),
    path("admin/vendors/<uuid:pk>/verify-kyc/", BusinessAdminViewSet.as_view({"post": "verify_kyc"})),

    path("admin/products/", BusinessAdminViewSet.as_view({"get": "list_products"})),
    path("admin/products/<slug:slug>/update/", BusinessAdminViewSet.as_view({"put": "update_product", "patch": "update_product"})),

    path("admin/orders/", BusinessAdminViewSet.as_view({"get": "orders"})),
    path("admin/orders/<uuid:pk>/assign-logistics/", BusinessAdminViewSet.as_view({"post": "assign_logistics"})),
    path("admin/orders/<uuid:pk>/refund/", BusinessAdminViewSet.as_view({"post": "process_refund"})),

    path("admin/payments/", BusinessAdminViewSet.as_view({"get": "payments"})),
    path("admin/vendors/<uuid:pk>/trigger-payout/", BusinessAdminViewSet.as_view({"post": "trigger_payout"})),
